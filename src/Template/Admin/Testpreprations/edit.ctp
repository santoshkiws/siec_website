            ...
            <?php  echo $this->Form->create($testpreprations,['class'=>'form-horizontal','enctype'=>'multipart/form-data']); ?>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <img src="<?php echo $this->request->webroot .'img/testpreprations/'. $testpreprations['image'];?>" class="user-image" style="height: 50px; width:100px;" alt="blog Image">
                  <?php
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <select class="form-control" name="status" id="status">
                              ...
                              <option value="1" <?php if (!empty($testpreprations) && $testpreprations['status'] == '1')  echo 'selected = "selected"'; ?>>Active</option>
                              <option value="0"<?php if (!empty($testpreprations) && $testpreprations['status'] == '0')  echo 'selected = "selected"'; ?>>Inactive</option>
                   </select>

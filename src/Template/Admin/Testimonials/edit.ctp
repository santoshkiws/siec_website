            ...
            <?php  echo $this->Form->create($testimonials,['class'=>'form-horizontal','enctype'=>'multipart/form-data']); ?>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <img src="<?php echo $this->request->webroot .'img/testimonials/'. $testimonials['image'];?>" class="user-image" style="height: 50px; width:100px;" alt="blog Image">
                  <?php
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <select class="form-control" name="country_id" id="country_id">
                              ...
                              <option value="<?php echo $countrie['id']; ?>" <?php if ($countrie['id'] == $testimonials['country_id']){ echo 'selected="selected"';} ?>><?php echo $countrie['countries_name']; ?></option>
                              <?php }?>
                   </select>

            ...
            <?php  echo $this->Form->create($scholarships,['class'=>'form-horizontal','enctype'=>'multipart/form-data']); ?>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <img src="<?php echo $this->request->webroot .'img/scholarships/'. $scholarships['image'];?>" class="user-image" style="height: 50px; width:100px;" alt="blog Image">
                  <?php
                   ...
                   <select class="form-control" name="author_id" id="author_id">
                    <option value="">Select Author</option> 
                        <?php foreach ($authorname as $author){?>
                         <option value="<?php echo $author['id']?>" <?php if ($author['id'] == $scholarships['author_id']){ echo 'selected="selected"';} ?>><?php echo $author['author_name']; ?></option>
                      <?php } ?>
                   </select>

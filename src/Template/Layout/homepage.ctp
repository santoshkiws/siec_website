...
<head>
	<meta charset="utf-8">
	<title>Siec -Education</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="description" content="">
	<meta name="author" content="">
	<link href="<?php echo $this->request->webroot . 'Maxim/css/bootstrap-responsive.css'?>" rel="stylesheet">
	<link href="<?php echo $this->request->webroot . 'Maxim/css/style.css'?>" rel="stylesheet">
	<link href="<?php echo $this->request->webroot . 'Maxim/color/default.css'?>" rel="stylesheet">
	<link rel="shortcut icon" href="<?php echo $this->request->webroot . 'siec_fav_icon.png'?>">
	<!-- =======================================================
    Theme Name: Maxim
...
<body>
		...
		<div class="navbar navbar-inverse navbar-fixed-top">
			<div class="navbar-inner">
				<div class="container">
				 ...
				 <h1 class="brand"><img src="<?php echo $this->request->webroot . 'img/siec.png'?>" height="120" width="130" class="img-circle" alt="User Image"></h1>
					<!-- <h1 class="brand"><a href="index.html">Siec</a></h1> -->
					<!-- navigation -->
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Welcome to the Siec.</h4>
        </div>
	...
	<!-- footer here -->
	<?php echo $this->element('homefooter'); ?>
	<a href="#" class="scrollup"><i class="icon-angle-up icon-square icon-bgdark icon-2x"></i></a>
	<script src="<?php echo $this->request->webroot . 'Maxim/js/jquery.js'?>"></script>
	<script src="<?php echo $this->request->webroot . 'Maxim/js/jquery.scrollTo.js'?>"></script>
	<script src="<?php echo $this->request->webroot . 'Maxim/js/jquery.nav.js'?>"></script>
	<script src="<?php echo $this->request->webroot . 'Maxim/js/jquery.localScroll.js'?>"></script>
	<script src="<?php echo $this->request->webroot . 'Maxim/js/bootstrap.js'?>"></script>
	<script src="<?php echo $this->request->webroot . 'Maxim/js/jquery.prettyPhoto.js'?>"></script>
	<script src="<?php echo $this->request->webroot . 'Maxim/js/isotope.js'?>"></script>
	<script src="<?php echo $this->request->webroot . 'Maxim/js/jquery.flexslider.js'?>"></script>
	<script src="<?php echo $this->request->webroot . 'Maxim/js/inview.js'?>"></script>
	<script src="<?php echo $this->request->webroot . 'Maxim/js/animate.js'?>"></script>
	<script src="<?php echo $this->request->webroot . 'Maxim/js/custom.js'?>"></script>
	<script src="<?php echo $this->request->webroot . 'Maxim/contactform/contactform.js'?>"></script>

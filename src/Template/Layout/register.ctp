...
<head>
  ...
  <title>AdminSiec | Registration Page</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo $this->request->webroot . 'adminlte/plugins/iCheck/square/blue.css'?>">
...
<!-- iCheck -->
<script src="<?php echo $this->request->webroot . 'adminlte/plugins/iCheck/icheck.min.js'?>"></script>
<script>
  $(function () {
    $('input').iCheck({
